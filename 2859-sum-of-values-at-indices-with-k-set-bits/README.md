...
<pre style="position: relative;"><strong>Input:</strong> nums = [5,10,1,5,2], k = 1
...
Hence, the answer is nums[1] + nums[2] + nums[4] = 13.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> nums = [4,3,2,1], k = 2
