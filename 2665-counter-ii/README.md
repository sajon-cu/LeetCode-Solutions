...
<pre style="position: relative;"><strong>Input:</strong> init = 5, calls = ["increment","reset","decrement"]
...
<pre style="position: relative;"><strong>Input:</strong> init = 0, calls = ["increment","increment","decrement","reset","reset"]
